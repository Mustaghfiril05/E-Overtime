...
.form-group {
    ...
    <hr>
    <form action="<?= base_url('overtime/detail_complete/'. $eovertime['id_overtime']); ?>" method="POST" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="col-lg-10 col-md-6">
            ...
            <div class="form-group row">
				    ...
				    <div class="col-lg-3">
                        <b><input type="text" class="form-control form-control-user" id="start_date" name="start_date" value="<?=date('d M Y (H:i:s)',strtotime($eovertime['start_date']))?>" readonly></b>
				    </div>
                <div class="form-group row">&nbsp;
