...
<ol class="breadcrumb" style="background-color: #3a3a3a;"> 
		<li class="breadcrumb-item">
			<a href="" style="color: white;">Complete E-Overtime</a>
		</li>
...
.form-group {
    ...
    <center>
        <p>
          <b>  .:: Complete E-Overtime ::. </b>
        </p>
    </center>
    <hr>
    <form action="<?= base_url('overtime/complete_overtime/'. $eovertime['id_overtime']); ?>" method="POST" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="col-lg-10 col-md-6">
            ...
            <div class="form-group row">
				      ...
				      <div class="col-lg-3">
                  <b><input type="text" class="form-control form-control-user" id="approve_start" name="approve_start" value="<?=date('d M Y (H:i:s)',strtotime($eovertime['approve_start']))?>" readonly></b></br>
                  <b><input type="input" class="form-control form-control-user" value="<?= number_format($lemburr['jam'])." Jam";  ?> <?= number_format($lemburr['menit'])." Menit";  ?>" readonly></b>
                    <!-- <b><input type="text" class="form-control form-control-user" id="jumlah" name="jumlah"></b>  -->
				      </div>
                <div class="form-group row">&nbsp;
                    <a style="color: black;"><b>To : <p style="color: red; font-size:60%;" class="text-left">.:: S/d ::.</p></b></a>
				          <div class="col-sm-10">
                    <b><input type="text" class="form-control form-control-user" id="approve_to" name="approve_to" value="<?=date('d M Y (H:i:s)',strtotime($eovertime['approve_to']))?>" readonly></b>
            ...
            <div class="form-group row">
                        <a style="color: black;"><b>Type Day &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <p style="color: red; font-size:60%;" class="text-left">.:: Tipe Hari ::.</p></b></a>
				        <div class="col-sm-2">
                ...
                <div class="form-group row">
                        <a style="color: black;"><b>Type Overtime : <p style="color: red; font-size:60%;" class="text-left">.:: Tipe Lembur ::.</p></b></a>
				          <div class="col-sm-6">
                    <select name="type_overtime" id="type_overtime" class="form-control">
                        <option value=""> -Type- </option>
          ...
          <?php } else {?>
            <div class="form-group row">
                        <a style="color: black;"><b>HR Approve Overtime From &nbsp;: <p style="color: red; font-size:60%;" class="text-left">.:: Lembur Aktual Dari ::.</p></b></a>
				    <div class="col-lg-3">
                        <b><input type="datetime-local" class="form-control form-control-user" id="approve_start" name="approve_start" value="<?= $eovertime['approve_start']; ?>" readonly></b>
				    </div>
                <div class="form-group row">&nbsp;
                        <a style="color: black;"><b>To : <p style="color: red; font-size:60%;" class="text-left">.:: S/d ::.</p></b></a>
				    <div class="col-sm-10">
                        <b><input type="datetime-local" class="form-control form-control-user" id="approve_to" name="approve_to" value="<?= $eovertime['approve_to']; ?>"readonly></b>
				    </div>
			    </div>
			</div>
            ...
            <div class="form-group row">
                        <a style="color: black;"><b>Type Day &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <p style="color: red; font-size:60%;" class="text-left">.:: Tipe Hari ::.</p></b></a>
				<div class="col-sm-2">
                <b><input type="text" class="form-control form-control-user" id="type_day" name="type_day" value="<?= $eovertime['type_day']; ?>"readonly></b>
				</div>
                <div class="form-group row">
                        <a style="color: black;"><b>Type Overtime : <p style="color: red; font-size:60%;" class="text-left">.:: Tipe Lembur ::.</p></b></a>
				<div class="col-sm-6">
                <b><input type="text" class="form-control form-control-user" id="type_overtime" name="type_overtime" value="<?= $eovertime['type_overtime']; ?>"readonly></b>
				</div>
			</div>
            </div>
            <?php }?>
...
<script type="text/javascript">
  ...
  function getDays(){
    var approve_start = new Date(document.getElementById('approve_start').value);
    var approve_to = new Date(document.getElementById('approve_to').value);
    //Here we will use getTime() function to get the time difference
    var time_difference = approve_to.getTime() - approve_start.getTime();
    ...
    var minutes_difference = time_difference / (1000*24);
    //alert(days);
    var hm_difference = hours_difference + minutes_difference;
    document.getElementById('jumlah').value = minutes_difference;
  }
</script>