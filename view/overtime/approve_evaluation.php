...
<!-- approve SPV -->
 <?php
  if($user['id_jabatan'] == 6 ) { ?>
    <form action="<?= base_url('overtime/approve_evaluation/'. $eovertime['id_overtime']); ?>" method="POST" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="col-lg-10 col-md-6">
          ...
          <?php
            if($eovertime['id_jabatan'] == 6 AND $eovertime['status'] == 'Evaluation') { ?>
        ...
        <div class="form-group row justify-content-end">
          ...
          <?php
          if($eovertime['status'] == 'HOD Approved') { ?>
            <a class="btn btn-success btn-sm" href="<?= base_url('overtime/')?>">Kembali</a>
          <?php } elseif ($eovertime['status'] == 'HOD Rejected') {?>
            <a class="btn btn-success btn-sm" href="<?= base_url('overtime/')?>">Kembali</a>
          <?php } ?>

          <?php
          if($eovertime['status'] == 'Evaluation Approved') { ?>
            <a class="btn btn-success btn-sm" href="<?= base_url('overtime/')?>">Kembali</a>
...
<!-- approve HOD & SPRD -->
 <?php } elseif ($user['id_jabatan'] == 46 OR $user['id_jabatan'] == 3 ) { ?>
  <form action="<?= base_url('overtime/approve_evaluation/'. $eovertime['id_overtime']); ?>" method="POST" enctype="multipart/form-data">
    <div class="table-responsive" style="height:650px; width: 74rem; overflow-x:hidden;" >
    <fieldset>
        <center>
        <div class="col-lg-10 col-md-6">
          ...
          <?php
            if($eovertime['id_jabatan'] == 46 OR $user['id_jabatan'] == 3 AND  $eovertime['status'] == 'Evaluation') { ?>
          ...
          <?php } elseif ($eovertime['id_jabatan'] == 6 AND  $eovertime['status'] == 'Evaluation') {?>
            ...
            <?php
            if($eovertime['id_jabatan'] == 46 OR $user['id_jabatan'] == 3 AND  $eovertime['status'] == 'Evaluation Approved') { ?>
...
<!-- View BOD -->
    ...
    <fieldset>
        ...
        <div class="col-lg-10 col-md-6">
          ...
          <?php
            if ($eovertime['id_jabatan'] == 3 OR $eovertime['id_jabatan'] == 46 AND  $eovertime['status'] == 'Evaluation') {?>
            <div class="form-group row">
                        <a style="color: black;"><b>Approve Evaluation? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <p style="color: red; font-size:60%;" class="text-left">.:: Alasan Lembur ::.</p></b></a>
				            <div class="col-sm-3">
                        <select name="status" id="status" class="form-control">
                            <option value=""> --Choose-- </option>
                            <option value="BOD Approved">BOD Approved</option>
						                <option value="BOD Rejected">BOD Rejected</option>
                        </select>
				            </div>
			        </div>
            <?php } elseif ($eovertime['status'] == 'Evaluation') {?>
